...
def violin_plot(group_name, pic_name, fill_col, edge_col):
    ...
    # ================= 3. Drawing =================
    # First Layer: Violin Illustration
    sns.violinplot(
    ...
    # Second Layer: Jittered Scatter Plot
    sns.stripplot(
        data=df, x='Group', y='Value',
        palette=[fill_col], hue='Group', legend=False,
    ...
    # ================= 5. Save Output =================
    plt.tight_layout()
    # Automatically Create a Save Folder
    save_dir = './V-P/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    # plt.savefig(f'{save_dir}violin_{pic_name}-1.png', bbox_inches='tight', dpi=600)
...
if __name__ == '__main__':
    ...
    # Automatic Color Scheme Rotation
